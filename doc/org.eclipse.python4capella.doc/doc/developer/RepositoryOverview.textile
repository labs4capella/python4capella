...
* the Python4Capella project that contains Python APIs and that will be zipped in the org.eclipse.python4capella plugin during build
* the Python4CapellaSampleScripts project that contains sample scipts and that will be zipped in the org.eclipse.python4capella plugin during build
