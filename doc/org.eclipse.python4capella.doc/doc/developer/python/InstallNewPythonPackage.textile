...
If you are using Windows and the python27.zip file provided with Python4Capella, you can install a new package using the following command from the folder where you extracted the python27.zip:
...
This will install the package and make it available to import in your scripts. For more details on importing the newly installed package please refer to its documentation.
...
Once you downloaded the archive, from the folder where you extracted the python27.zip, you can use the following command to install the package, in this example:
