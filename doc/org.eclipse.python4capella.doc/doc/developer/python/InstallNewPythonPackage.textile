...
NOTE: there is a known issue with the use of panda/numpy packages. See this "issue":https://github.com/labs4capella/python4capella/issues/112 for more details and workaround.
