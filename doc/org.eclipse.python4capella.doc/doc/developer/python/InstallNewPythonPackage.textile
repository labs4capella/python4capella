...
If you are using Windows and the python37.zip file provided with Python for Capella, you can install a new package using the following command from the folder where you extracted the python37.zip:
