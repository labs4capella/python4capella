...
This is a quick introduction to the openpyxl library. You can check the "project page":https://openpyxl.readthedocs.io/en/stable/ or provided examples to "read from an xlsx file":https://github.com/labs4capella/python4capella/blob/master/plugins/Python4CapellaSampleScripts/sample_scripts/Import_breakdown_Node_PCs_from_xlsx.py or to "write to an xlsx file":https://github.com/labs4capella/python4capella/blob/master/plugins/Python4CapellaSampleScripts/sample_scripts/Import_breakdown_Node_PCs_from_xlsx.py for more details.
