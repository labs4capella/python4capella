...
Now you need to add your project to the list of scripting locations:
...
Finally, you need to add the Python4Capella project as a dependency of your project. To do so, you need to make sure you are in the PyDev perspective. If it's not the case, you can click on the perspective button on the top right corner of your Capella and select the PyDev perspective.
...
Now you will need to import the Capella APIs:
