...
bq. Note: you can find existing examples in "Python4CapellaSampleScripts/sample_scripts":https://github.com/labs4capella/python4capella/tree/master/plugins/Python4CapellaSampleScripts/sample_scripts/.
