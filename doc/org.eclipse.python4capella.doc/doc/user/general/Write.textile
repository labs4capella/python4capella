...
You will need to import the Capella APIs (This statement can produce an error, but you can "remove":RemoveFalseErrors.html it):
...
Note: you can find existing examples in "Python4Capella/sample_scripts":https://github.com/labs4capella/python4capella/tree/master/plugins/Python4Capella/sample_scripts/.
...
It's possible to contribute a menu to Capella that will run your script by adding the following header at the beginning of your script:
